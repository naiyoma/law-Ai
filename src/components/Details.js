  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Research and Publications:</h3>
              <p class="text-gray-500 dark:text-gray-400">Foster a culture of research by encouraging students and professionals to engage in projects and publish papers or
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Collaborative Initiatives</h3>
              <p class="text-gray-500 dark:text-gray-400">Foster collaborations with other student societies, organizations, and institutions within Kenya and across Africa that
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Outreach and Partnerships</h3>
              <p class="text-gray-500 dark:text-gray-400">Engage relevant stakeholders such as government agencies, technology companies, legal firms, and non-profit
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Resource Development</h3>
              <p class="text-gray-500 dark:text-gray-400">Develop an online repository or website as a comprehensive resource hub, offering articles, legal frameworks, case
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Evaluation and Growth:</h3>
              <p class="text-gray-500 dark:text-gray-400">Conduct regular evaluations and seek feedback from members to assess the impact and effectiveness of the Tech AI Law
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Workshops and Seminars:</h3>
              <p class="text-gray-500 dark:text-gray-400">Host interactive workshops and seminars focused on specific legal topics related to technology, artificial intelligence,
